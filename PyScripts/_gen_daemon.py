...
#
# Modified for Python 3 (see also: http://web.archive.org/web/201310171304
# 34/http://www.jejik.com/files/examples/daemon3x.py)
#
...
class Daemon:
    ...
    def quit(self):
        ...
        be called before the process is stopped.
        """
        return
